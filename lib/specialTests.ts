...
export const TESTS: SpecialTest[] = [
  ...
  { id: "pv1", r: "si", cat: "Ligament", n: "Long dorsal SIJ ligament (LDL) palpation", t: "Long dorsal sacroiliac ligament pathology / SIJ-related pain", p: "Prone or side-lying; palpate directly over the long dorsal sacroiliac ligament, just inferomedial to the PSIS between the PSIS and the sacral sulcus.", pos: "Focal tenderness reproducing the patient's pain — often associated with SIJ-related or postpartum pelvic girdle pain.", tier: 3, pearl: "A purely palpatory sign, not a provocation maneuver — best interpreted alongside a provocation cluster (e.g. Laslett's, cl_si) rather than in isolation." },
  { id: "pv2", r: "si", cat: "Provocation", n: "Mennell's sign", t: "SIJ dysfunction", p: "Prone (or side-lying); stabilise the pelvis/sacrum with one hand and passively extend the straight leg at the hip with the other.", pos: "Reproduction of pain localised to the SIJ region.", tier: 3, pearl: "A historically-described test with limited modern evidence — most useful as part of a broader SIJ provocation picture rather than alone." },
  { id: "pv3", r: "si", cat: "Provocation", n: "Yeoman's test", t: "Anterior SIJ / sacroiliac ligament stress", p: "Prone; flex the knee to 90°, stabilise the sacrum, then passively extend (lift) the hip.", pos: "Reproduction of SIJ pain as the ilium rotates anteriorly on the sacrum.", tier: 3 },
